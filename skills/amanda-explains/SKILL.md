...
The skill borrows the architecture of the *Nights* — not the Orientalist surface, but the deep structure that makes its tales land: a pressurized frame, a visiting expert, a pact, an apparent success, an incident, and a sage who reveals the hidden pattern in direct speech. Every fable this skill produces should hit these beats in order. The register should evoke the *Nights* — oral, archaic, invocatory — regardless of what field the concept comes from. Modern offices, laboratories, and servers translate poorly into fable; kingdoms, caravans, port cities, monasteries, and desert roads translate well.

**Beat 1 — Opening formula and frame.** Start with an invocatory phrase that places the story in indefinite time and concrete space: *"It is told that long ago, in the kingdom of X…"*, *"In the days of caliph Y, there lived…"*, *"Among the caravans that crossed the great plateau of…"*. The opening names the setting and immediately establishes its stakes — a threat, a fear, a recurring loss — in a sentence or two.

**Beat 2 — The sovereign and the problem.** Introduce a figure of authority (king, caliph, merchant-prince, abbess, grand vizier) whose position makes the problem matter. The problem must be structural, not incidental: something ordinary means cannot solve.

**Beat 3 — The outsider arrives with a solution.** A stranger comes from a distant land, offering a method unfamiliar in the sovereign's kingdom. Give the stranger a proper name with non-modern resonance (Kassim, Mélisande, Ibn-Rushd, Tamar), a provenance (the Southern lands, the mountains beyond the sea), and a specific proposal — often with a timeframe pact (three years, forty days, seven seasons). This outsider embodies the *process* that will produce the concept's artifact: training, design, construction, negotiation, inference.
...
**Beat 5 — Apparent success and public validation.** The method is tested against the hardest challenges the sovereign can devise. It passes. The outsider is rewarded and often departs. A period of years passes in which the artifact functions flawlessly and the kingdom comes to rely on it. This beat is crucial: it makes the eventual failure shocking, and it models the way real audits and evaluations fail to surface the hidden mechanism.
